                          ...
                          if($res)
                          {
                              ...
                              foreach($data_paket as $row)
                              {
                                echo "<tr>
                                  ...
                                  <td>
                                      <a href='admin-paket.php?aksi=ubah&id_paket=".$row['id_paket']."' class='btn btn-sm btn-info'><i class='fas fa-edit'></i></a> | 
                                      <a href='admin-paket.php?aksi=hapus&id_paket=".$row['id_paket']."' class='btn btn-sm btn-danger'><i class='fas fa-trash'></i></a>
                                  </td>
                              </tr>";
                              }
                              $res->free();
